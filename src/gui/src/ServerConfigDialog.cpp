...
{
#if defined(Q_OS_WIN)
  const QString deskflowConfigFilter(QString("Deskflow Configurations (*.sgc);;All files (*.*)"));
#else
  const QString deskflowConfigFilter(QString("Deskflow Configurations (*.conf);;All files (*.*)"));
#endif
